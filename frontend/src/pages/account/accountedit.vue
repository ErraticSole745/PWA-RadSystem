                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlname" v-model.trim="formData.name"  label="Name" type="text" placeholder="Escribir Name"      
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <div class="q-mb-sm">
                                                        <q-uploader-input show-uploaded-files :max-files="1" :max-file-size="3" accept=".jpg,.png,.gif,.jpeg" :multiple="false" delete-icon="clear" style="width:100%" label="Elija archivos o suelte archivos aquí" upload-path="fileuploader/upload/photo" v-model="formData.photo"  ></q-uploader-input>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrluser_role_id" v-model.trim="formData.user_role_id"  label="User Role Id" type="number" placeholder="Escribir User Role Id"   step="any"    
                                                    class="" :error="isFieldValid('user_role_id')" :error-message="getFieldError('user_role_id')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
