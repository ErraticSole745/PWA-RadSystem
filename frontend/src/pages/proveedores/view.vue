                        ...
                        <div  class="col comp-grid" >
                            <div >
                                <div class="q-mb-3 row justify-start q-col-gutter-sm">
                                    ...
                                    <div class="col-12">
                                        <q-card  class="q-pa-md nice-shadow-6">
                                            <div class="row q-col-gutter-x-md items-center">
                                                <div class="col">
                                                    <div class="text-grey text-weight-medium mb-1">Numero</div>
                                                    <div class="text-bold">{{ item.numero }}</div>
                                                </div>
                                            </div>
                                        </q-card>
                                    </div>
                                ...
                                <div  class=" row q-col-gutter-xs justify-start q-ma-md">
                                    <div><q-btn icon="edit" label="Edit"  outline  :rounded="false"  no-caps  unelevated   padding="xs" color="positive" title="Editar"  @click="app.openPageDialog({ page:'proveedores/edit', url: `/proveedores/edit/${item.id}` , closeBtn: true })">
                                    </q-btn></div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'proveedoresview',
		},
		apiPath: {
			type: String,
			default: 'proveedores/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
