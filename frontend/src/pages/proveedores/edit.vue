                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlnumero" v-model.trim="formData.numero"  label="Numero" type="text" placeholder="Escribir Numero"      
                                                    class="" :error="isFieldValid('numero')" :error-message="getFieldError('numero')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'proveedoresedit',
		},
		pagePath: {
			type : String,
			default : 'proveedores/edit',
		},
		apiPath: {
			type: String,
			default: 'proveedores/edit',
